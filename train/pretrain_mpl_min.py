...
def main():
    ...
    def _gather_state() -> dict:
        ...
        meta_payload["angvel_normalization_invariant"] = "angvel_vec_from_R_seq uses fps-scaled standard axis-angle velocity."
        meta_payload["migration_note"] = (
            "2026-03-18: pretrain_mpl_min bundle export stamped with standard rotvec semantics "
            "so smoke bundles satisfy trainbase MotionEncoder contract."
        )
        stamp_standard_rotvec_spec(payload, asset_kind="motion_encoder_bundle", source="pretrain_mpl_min")
        return payload
